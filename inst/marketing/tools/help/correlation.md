Create a correlation matrix of the selected variable. Correlations and p-values are provided for each variable pair. A visual representation of the correlation matrix is provided in the Plots tab.
